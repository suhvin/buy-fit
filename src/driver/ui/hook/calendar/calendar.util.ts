import { addDays, addMonths, getDaysInMonth, isSameMonth, startOfMonth, subMonths } from "date-fns";
...
export const getNextDayCount = (currentDayLength: number, prevDayLength: number) => {
...
export const isOutSideMonth = (aDate: Date, bDate: Date) => {
